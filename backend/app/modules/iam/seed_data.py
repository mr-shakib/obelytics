...
ALL_PERMISSIONS: list[dict] = [
    ...
    {"code": "user.delete",                   "module": "iam",          "description": "Delete users"},
    ...
    # ── OBE ───────────────────────────────────────────────────────────────────
    {"code": "mission.create",                "module": "obe",          "description": "Create program missions"},
    {"code": "mission.update",                "module": "obe",          "description": "Update/archive program missions"},
    {"code": "mission.read",                  "module": "obe",          "description": "Read program missions"},
    {"code": "peo.create",                    "module": "obe",          "description": "Create program educational objectives"},
    {"code": "peo.update",                    "module": "obe",          "description": "Update/archive PEOs and their mappings"},
    {"code": "peo.read",                      "module": "obe",          "description": "Read program educational objectives"},
    ...
    {"code": "enrollment.manage_own",         "module": "assessment",   "description": "Enroll/unenroll students in your assigned sections"},
    # ── Attainment ────────────────────────────────────────────────────────────
...
ROLES: list[dict] = [
    ...
    {
        "name": _PC,
        "description": "Full application access for assigned programs",
        "permissions": [p["code"] for p in ALL_PERMISSIONS],
    },
    {
        "name": _ML,
